/**
 * About Page - Kinetic Minimalism Design
...
export default function About() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container relative z-10">
          <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground mb-4 md:mb-6 leading-tight">
              ...
              <span className="text-primary">(And What Doesn't)</span>{" "}
      ...
      <section className="relative py-12 md:py-20 lg:py-28">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="bg-card/60 backdrop-blur-xl rounded-3xl border border-border/50 p-6 sm:p-8 md:p-12 lg:p-16 shadow-xl">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              {strengths.map((strength, index) => (
                <div
                  key={index}
                  className="bg-card/60 backdrop-blur-xl rounded-2xl border border-border/50 p-6 sm:p-8 hover:shadow-xl transition-all duration-500"
                  style={{
                    opacity: inView ? 1 : 0,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {principles.map((principle, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="group bg-card/60 backdrop-blur-xl rounded-2xl border border-border/50 p-6 sm:p-8 hover:shadow-xl transition-all duration-500"
                    style={{
                      opacity: inView ? 1 : 0,
                      transform: inView ? 'translateY(0)' : 'translateY(20px)',
      ...
      {/* CTA Section */}
      <section className="relative py-12 md:py-20 lg:py-28 bg-gradient-to-b from-background via-primary/5 to-background">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="bg-card/70 backdrop-blur-xl rounded-3xl border border-border/50 p-8 md:p-12 lg:p-16 shadow-2xl text-center">
              <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4 md:mb-6">
                Let's See If We Can <span className="text-primary">Help</span>
              </h2>
